...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
	String pjaxContentJSP = request.getAttribute("pjax-content")
			+ ".jsp";
%><!DOCTYPE html>
<html>
<head>
				...
				<ul class="nav navbar-nav navbar-right">
					<c:choose>
						<c:when test="${currentUser.id ne null }">
							<%--登录用户 --%>
							<li class="dropdown"><a href="<%=basePath%>roborder"><span
									class="glyphicon glyphicon-gift"></span> <span
									class="hidden-sm">我要免费打印</span></a></li>
							<li class="dropdown"><a id="user" href="#"
								class="dropdown-toggle" data-toggle="dropdown"> <c:choose>
									...
									</c:choose> <span class="hidden-sm">${currentUser.c }</span> <span
									class="caret"></span>
							</a>
