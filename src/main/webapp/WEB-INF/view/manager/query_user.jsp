	...
	<div class="main-content" style="margin-left:0px;">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					关于用户 <small> <i class="icon-double-angle-right"></i>
						请慎重操作！！！
					</small>
				</h1>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="alert alert-info">
						<i class="icon-hand-right"></i> 管理员对用户权限的任何操作都要负相关责任！！！
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			jQuery(grid_selector).jqGrid({
				...
				url: '<%=basePath%>bunko/query_userlist',
				datatype : 'json',
				height : 250,
				colNames : [ ' ','用户id', '用户名',  '用户邮箱', '用户身份','上一次登陆时间'],
				colModel : [ {
					name : 'myac',
					index : '',
					width : 80,
					...
					//editformbutton:false, editOptions:{recreateForm: false, beforeShowForm:beforeEditCallback}
					}
				}, {
					name : 'id',
					index : 'id',
				...
				loadComplete : function() {
				 ...
				 //	editurl : '<%=basePath%>admin/edituserauth', 
				 		caption : "用户管理在线编辑",
