...
public class ManagerController {
	 ...
	 * */
	@SinglePage
	@RequestMapping("get_total_payment")
	public String get_total_payment(HttpServletRequest request) {

		return "manager/total_payment";
	}
	 ...
	 * */
	@ResponseBody
	@RequestMapping("get_total_payment_")
	public List<HashMap<String,Object>> get_total_payment_(
			@RequestParam(required = false) String page,
			@RequestParam(required = false) String rows,
			HttpServletRequest request) {
		
		return managerService.get_payment_detail();
	}
}
